...
JobText_SaveDir=../../run/chicNoTDC/job_text/inclusiveMC

for num in {1..394}
do
    file_list=mc_664p03_psip_12mc_20G-${num}.txt
    rootfile=chicNoTDC_psip_mc-${num}.root
    ...
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "ChicNoTDC.IsMonteCarlo=\"true\";                             " >> ${JobText_SaveDir}/${jobOptions}
    echo   "ChicNoTDC.OutputFileName=\"\$HOME/bes/chic2invi/v0.1/run/chicNoTDC/rootfile_inclusiveMC/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
