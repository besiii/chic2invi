...
JobText_SaveDir=../../run/chicNoTDC/job_text/data3650

for num in {1..84}
do
    file_list=data_663p01_3650_20G-${num}.txt
    rootfile=chicNoTDC_data3650-${num}.root
    jobOptions=jobOptions_chicNoTDC_data3650-${num}.txt
    ...
    echo   "#include \"\$HOME/bes/chic2invi/v0.1/run/samples/data3650/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "ChicNoTDC.OutputFileName=\"/besfs/groups/nphy/users/xiaosy/bes/chic2invi/v0.1/run/chicNoTDC/rootfile_data3650/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
