...
do
    ...
    rootfile=chic2incl_psip_data-${num}.root
    ...
    echo   "Chic2invi.OutputFileName=\"\$HOME/bes/chic2invi/v0.1/run/chic2incl/rootfile_data/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
