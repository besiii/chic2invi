...
gongli_no_config (from PROJECT) excludes [gongli_config]
gongli_root (from PROJECT) excludes [gongli_no_root]
gongli_cleanup (from PROJECT) excludes [gongli_no_cleanup]
gongli_prototypes (from PROJECT) excludes [gongli_no_prototypes]
gongli_with_installarea (from PROJECT) excludes [gongli_without_installarea]
gongli_with_version_directory (from PROJECT) excludes [gongli_without_version_directory]
gongli (from PROJECT)
...
----------> CMTPATH
# Add path /workfs/bes/gongli/workarea from initialization
