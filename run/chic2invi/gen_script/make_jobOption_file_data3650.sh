...
do
    ...
    rootfile=chic2invi_data3650-${num}.root
    jobOptions=jobOptions_chic2invi_data3650-${num}.txt
    ...
    echo   "Chic2invi.OutputFileName=\"/besfs/groups/nphy/users/xiaosy/bes/chic2invi/v0.1/run/chic2invi/rootfile_data3650/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
