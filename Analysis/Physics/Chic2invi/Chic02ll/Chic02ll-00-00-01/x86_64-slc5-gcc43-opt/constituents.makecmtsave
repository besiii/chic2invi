...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(Chic02ll_tag).make
cmt_local_tagfile = $(bin)$(Chic02ll_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_Chic02llsetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_Chic02llsetup.make
else
#cmt_local_setup = $(bin)Chic02llsetup$(cmt_lock_pid).make
...
Chic02ll_extratags = -tag_add=target_Chic02ll

#$(cmt_local_tagfile_Chic02ll) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Chic02ll) ::
else
$(cmt_local_tagfile_Chic02ll) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_Chic02ll)"
	@if test -f $(cmt_local_tagfile_Chic02ll); then /bin/rm -f $(cmt_local_tagfile_Chic02ll); fi ; \
	  $(cmtexe) -tag=$(tags) $(Chic02ll_extratags) build tag_makefile >>$(cmt_local_tagfile_Chic02ll); \
	  if test -f $(cmt_final_setup_Chic02ll); then /bin/rm -f $(cmt_final_setup_Chic02ll); fi; \
	  $(cmtexe) -tag=$(tags) $(Chic02ll_extratags) show setup >>$(cmt_final_setup_Chic02ll)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_Chic02ll_makefile) :: $(Chic02ll_dependencies) $(cmt_local_tagfile_Chic02ll) build_library_links dirs
else
$(cmt_local_Chic02ll_makefile) :: $(cmt_local_tagfile_Chic02ll)
endif
	$(echo) "(constituents.make) Building Chic02ll.make"; \
	  $(cmtexe) -tag=$(tags) $(Chic02ll_extratags) build constituent_makefile -out=$(cmt_local_Chic02ll_makefile) Chic02ll

Chic02ll :: $(Chic02ll_dependencies) $(cmt_local_Chic02ll_makefile)
	$(echo) "(constituents.make) Starting Chic02ll"
	@$(MAKE) -f $(cmt_local_Chic02ll_makefile) cmt_lock_pid=$${cmt_lock_pid} Chic02ll
	$(echo) "(constituents.make) Chic02ll done"

clean :: Chic02llclean

Chic02llclean :: $(Chic02llclean_dependencies) ##$(cmt_local_Chic02ll_makefile)
	$(echo) "(constituents.make) Starting Chic02llclean"
	@-if test -f $(cmt_local_Chic02ll_makefile); then \
	  $(MAKE) -f $(cmt_local_Chic02ll_makefile) cmt_lock_pid=$${cmt_lock_pid} Chic02llclean; \
	fi

##	  /bin/rm -f $(cmt_local_Chic02ll_makefile) $(bin)Chic02ll_dependencies.make

install :: Chic02llinstall

Chic02llinstall :: $(Chic02ll_dependencies) $(cmt_local_Chic02ll_makefile)
	$(echo) "(constituents.make) Starting install Chic02ll"
	@-$(MAKE) -f $(cmt_local_Chic02ll_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install Chic02ll done"

uninstall :: Chic02lluninstall

Chic02lluninstall :: $(cmt_local_Chic02ll_makefile)
	$(echo) "(constituents.make) Starting uninstall Chic02ll"
	@-$(MAKE) -f $(cmt_local_Chic02ll_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall Chic02ll done"
...
ifdef READONLY
cmt_local_tagfile_install_runtime = /tmp/CMT_$(Chic02ll_tag)_install_runtime.make$(cmt_lock_pid)
cmt_final_setup_install_runtime = /tmp/CMT_Chic02ll_install_runtimesetup.make
cmt_local_install_runtime_makefile = /tmp/CMT_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_runtime = $(Chic02ll_tag)_install_runtime.make
cmt_local_tagfile_install_runtime = $(bin)$(Chic02ll_tag)_install_runtime.make
cmt_final_setup_install_runtime = $(bin)Chic02ll_install_runtimesetup.make
...
ifdef READONLY
cmt_local_tagfile_install_runtime = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_install_runtime = /tmp/CMT_Chic02llsetup.make
cmt_local_install_runtime_makefile = /tmp/CMT_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_runtime = $(Chic02ll_tag).make
cmt_local_tagfile_install_runtime = $(bin)$(Chic02ll_tag).make
cmt_final_setup_install_runtime = $(bin)Chic02llsetup.make
cmt_local_install_runtime_makefile = $(bin)install_runtime.make
endif
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(Chic02ll_tag)_config.make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_Chic02ll_configsetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
#cmt_local_tagfile_config = $(Chic02ll_tag)_config.make
cmt_local_tagfile_config = $(bin)$(Chic02ll_tag)_config.make
cmt_final_setup_config = $(bin)Chic02ll_configsetup.make
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_Chic02llsetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
#cmt_local_tagfile_config = $(Chic02ll_tag).make
cmt_local_tagfile_config = $(bin)$(Chic02ll_tag).make
cmt_final_setup_config = $(bin)Chic02llsetup.make
cmt_local_config_makefile = $(bin)config.make
endif
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Chic02ll_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Chic02ll_install_includessetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(Chic02ll_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Chic02ll_tag)_install_includes.make
cmt_final_setup_install_includes = $(bin)Chic02ll_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Chic02llsetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(Chic02ll_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Chic02ll_tag).make
cmt_final_setup_install_includes = $(bin)Chic02llsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Chic02ll_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Chic02ll_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(Chic02ll_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Chic02ll_tag)_make.make
cmt_final_setup_make = $(bin)Chic02ll_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Chic02llsetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(Chic02ll_tag).make
cmt_local_tagfile_make = $(bin)$(Chic02ll_tag).make
cmt_final_setup_make = $(bin)Chic02llsetup.make
cmt_local_make_makefile = $(bin)make.make
endif
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Chic02ll_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Chic02ll_CompilePythonsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(Chic02ll_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Chic02ll_tag)_CompilePython.make
cmt_final_setup_CompilePython = $(bin)Chic02ll_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Chic02llsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(Chic02ll_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Chic02ll_tag).make
cmt_final_setup_CompilePython = $(bin)Chic02llsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Chic02ll_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Chic02ll_qmtest_runsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(Chic02ll_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Chic02ll_tag)_qmtest_run.make
cmt_final_setup_qmtest_run = $(bin)Chic02ll_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Chic02llsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(Chic02ll_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Chic02ll_tag).make
cmt_final_setup_qmtest_run = $(bin)Chic02llsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Chic02ll_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Chic02ll_qmtest_summarizesetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(Chic02ll_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Chic02ll_tag)_qmtest_summarize.make
cmt_final_setup_qmtest_summarize = $(bin)Chic02ll_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Chic02llsetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(Chic02ll_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Chic02ll_tag).make
cmt_final_setup_qmtest_summarize = $(bin)Chic02llsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Chic02ll_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Chic02ll_TestPackagesetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(Chic02ll_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Chic02ll_tag)_TestPackage.make
cmt_final_setup_TestPackage = $(bin)Chic02ll_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Chic02llsetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(Chic02ll_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Chic02ll_tag).make
cmt_final_setup_TestPackage = $(bin)Chic02llsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Chic02ll_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Chic02ll_TestProjectsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(Chic02ll_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Chic02ll_tag)_TestProject.make
cmt_final_setup_TestProject = $(bin)Chic02ll_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Chic02llsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(Chic02ll_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Chic02ll_tag).make
cmt_final_setup_TestProject = $(bin)Chic02llsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
endif
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Chic02ll_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Chic02ll_new_rootsyssetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(Chic02ll_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Chic02ll_tag)_new_rootsys.make
cmt_final_setup_new_rootsys = $(bin)Chic02ll_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Chic02llsetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(Chic02ll_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Chic02ll_tag).make
cmt_final_setup_new_rootsys = $(bin)Chic02llsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
endif
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Chic02ll_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Chic02ll_DatabaseSvc_check_install_scriptssetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Chic02ll_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Chic02ll_tag)_DatabaseSvc_check_install_scripts.make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Chic02ll_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Chic02ll_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Chic02llsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Chic02ll_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Chic02ll_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Chic02llsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
endif
...
Chic02ll_check_install_runtime_extratags = -tag_add=target_Chic02ll_check_install_runtime

#$(cmt_local_tagfile_Chic02ll_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Chic02ll_check_install_runtime) ::
else
$(cmt_local_tagfile_Chic02ll_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_Chic02ll_check_install_runtime)"
	@if test -f $(cmt_local_tagfile_Chic02ll_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_Chic02ll_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(Chic02ll_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_Chic02ll_check_install_runtime); \
	  if test -f $(cmt_final_setup_Chic02ll_check_install_runtime); then /bin/rm -f $(cmt_final_setup_Chic02ll_check_install_runtime); fi; \
	  $(cmtexe) -tag=$(tags) $(Chic02ll_check_install_runtime_extratags) show setup >>$(cmt_final_setup_Chic02ll_check_install_runtime)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_Chic02ll_check_install_runtime_makefile) :: $(Chic02ll_check_install_runtime_dependencies) $(cmt_local_tagfile_Chic02ll_check_install_runtime) build_library_links dirs
else
$(cmt_local_Chic02ll_check_install_runtime_makefile) :: $(cmt_local_tagfile_Chic02ll_check_install_runtime)
endif
	$(echo) "(constituents.make) Building Chic02ll_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Chic02ll_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_Chic02ll_check_install_runtime_makefile) Chic02ll_check_install_runtime

Chic02ll_check_install_runtime :: $(Chic02ll_check_install_runtime_dependencies) $(cmt_local_Chic02ll_check_install_runtime_makefile)
	$(echo) "(constituents.make) Creating Chic02ll_check_install_runtime${lock_suffix} and Starting Chic02ll_check_install_runtime"
	@${lock_command} Chic02ll_check_install_runtime${lock_suffix} || exit $$?; \
	  retval=$$?; \
	  trap '${unlock_command} Chic02ll_check_install_runtime${lock_suffix}; exit $${retval}' 1 2 15; \
	  $(MAKE) -f $(cmt_local_Chic02ll_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} Chic02ll_check_install_runtime; \
	  retval=$$?; ${unlock_command} Chic02ll_check_install_runtime${lock_suffix}; exit $${retval}
	$(echo) "(constituents.make) Chic02ll_check_install_runtime done"

clean :: Chic02ll_check_install_runtimeclean

Chic02ll_check_install_runtimeclean :: $(Chic02ll_check_install_runtimeclean_dependencies) ##$(cmt_local_Chic02ll_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting Chic02ll_check_install_runtimeclean"
	@-if test -f $(cmt_local_Chic02ll_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Chic02ll_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} Chic02ll_check_install_runtimeclean; \
	fi

##	  /bin/rm -f $(cmt_local_Chic02ll_check_install_runtime_makefile) $(bin)Chic02ll_check_install_runtime_dependencies.make

install :: Chic02ll_check_install_runtimeinstall

Chic02ll_check_install_runtimeinstall :: $(Chic02ll_check_install_runtime_dependencies) $(cmt_local_Chic02ll_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install Chic02ll_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_Chic02ll_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install Chic02ll_check_install_runtime done"

uninstall :: Chic02ll_check_install_runtimeuninstall

Chic02ll_check_install_runtimeuninstall :: $(cmt_local_Chic02ll_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall Chic02ll_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_Chic02ll_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall Chic02ll_check_install_runtime done"

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ Chic02ll_check_install_runtime"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ Chic02ll_check_install_runtime done"
endif
