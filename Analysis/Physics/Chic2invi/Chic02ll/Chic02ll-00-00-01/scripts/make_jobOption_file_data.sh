...
JobText_SaveDir=../run/data

for num in {1..514}
do
    file_list=job_${num}.txt
    ...
    echo   "#include \"\$HOME/bes/chic2invi/v0.1/Analysis/Physics/Chic2invi/Chic02ll/Chic02ll-00-00-01/run/data/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "ApplicationMgr.DLLs += {\"Chic02ll\"};                       " >> ${JobText_SaveDir}/${jobOptions}
    echo   "ApplicationMgr.TopAlg += { \"Chic02ll\" };                   " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    ...
    echo   "Chic2invi.OutputFileName=\"\$HOME/bes/chic2invi/v0.1/Chic02ll/Chic02ll-00-00-01/run/rootfile_data/$rootfile\"; " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
    echo   "                                                              " >> ${JobText_SaveDir}/${jobOptions}
done
