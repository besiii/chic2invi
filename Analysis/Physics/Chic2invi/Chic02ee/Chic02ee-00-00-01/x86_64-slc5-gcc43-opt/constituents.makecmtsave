...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(Chic02ee_tag).make
cmt_local_tagfile = $(bin)$(Chic02ee_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_Chic02eesetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_Chic02eesetup.make
else
#cmt_local_setup = $(bin)Chic02eesetup$(cmt_lock_pid).make
...
Chic02ee_extratags = -tag_add=target_Chic02ee

#$(cmt_local_tagfile_Chic02ee) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Chic02ee) ::
else
$(cmt_local_tagfile_Chic02ee) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_Chic02ee)"
	@if test -f $(cmt_local_tagfile_Chic02ee); then /bin/rm -f $(cmt_local_tagfile_Chic02ee); fi ; \
	  $(cmtexe) -tag=$(tags) $(Chic02ee_extratags) build tag_makefile >>$(cmt_local_tagfile_Chic02ee); \
	  if test -f $(cmt_final_setup_Chic02ee); then /bin/rm -f $(cmt_final_setup_Chic02ee); fi; \
	  $(cmtexe) -tag=$(tags) $(Chic02ee_extratags) show setup >>$(cmt_final_setup_Chic02ee)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_Chic02ee_makefile) :: $(Chic02ee_dependencies) $(cmt_local_tagfile_Chic02ee) build_library_links dirs
else
$(cmt_local_Chic02ee_makefile) :: $(cmt_local_tagfile_Chic02ee)
endif
	$(echo) "(constituents.make) Building Chic02ee.make"; \
	  $(cmtexe) -tag=$(tags) $(Chic02ee_extratags) build constituent_makefile -out=$(cmt_local_Chic02ee_makefile) Chic02ee

Chic02ee :: $(Chic02ee_dependencies) $(cmt_local_Chic02ee_makefile)
	$(echo) "(constituents.make) Starting Chic02ee"
	@$(MAKE) -f $(cmt_local_Chic02ee_makefile) cmt_lock_pid=$${cmt_lock_pid} Chic02ee
	$(echo) "(constituents.make) Chic02ee done"

clean :: Chic02eeclean

Chic02eeclean :: $(Chic02eeclean_dependencies) ##$(cmt_local_Chic02ee_makefile)
	$(echo) "(constituents.make) Starting Chic02eeclean"
	@-if test -f $(cmt_local_Chic02ee_makefile); then \
	  $(MAKE) -f $(cmt_local_Chic02ee_makefile) cmt_lock_pid=$${cmt_lock_pid} Chic02eeclean; \
	fi

##	  /bin/rm -f $(cmt_local_Chic02ee_makefile) $(bin)Chic02ee_dependencies.make

install :: Chic02eeinstall

Chic02eeinstall :: $(Chic02ee_dependencies) $(cmt_local_Chic02ee_makefile)
	$(echo) "(constituents.make) Starting install Chic02ee"
	@-$(MAKE) -f $(cmt_local_Chic02ee_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install Chic02ee done"

uninstall :: Chic02eeuninstall

Chic02eeuninstall :: $(cmt_local_Chic02ee_makefile)
	$(echo) "(constituents.make) Starting uninstall Chic02ee"
	@-$(MAKE) -f $(cmt_local_Chic02ee_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall Chic02ee done"
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(Chic02ee_tag)_config.make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_Chic02ee_configsetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
#cmt_local_tagfile_config = $(Chic02ee_tag)_config.make
cmt_local_tagfile_config = $(bin)$(Chic02ee_tag)_config.make
cmt_final_setup_config = $(bin)Chic02ee_configsetup.make
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_Chic02eesetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
#cmt_local_tagfile_config = $(Chic02ee_tag).make
cmt_local_tagfile_config = $(bin)$(Chic02ee_tag).make
cmt_final_setup_config = $(bin)Chic02eesetup.make
cmt_local_config_makefile = $(bin)config.make
endif
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Chic02ee_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Chic02ee_install_includessetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(Chic02ee_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Chic02ee_tag)_install_includes.make
cmt_final_setup_install_includes = $(bin)Chic02ee_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Chic02eesetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(Chic02ee_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Chic02ee_tag).make
cmt_final_setup_install_includes = $(bin)Chic02eesetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Chic02ee_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Chic02ee_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(Chic02ee_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Chic02ee_tag)_make.make
cmt_final_setup_make = $(bin)Chic02ee_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Chic02eesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(Chic02ee_tag).make
cmt_local_tagfile_make = $(bin)$(Chic02ee_tag).make
cmt_final_setup_make = $(bin)Chic02eesetup.make
cmt_local_make_makefile = $(bin)make.make
endif
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Chic02ee_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Chic02ee_CompilePythonsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(Chic02ee_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Chic02ee_tag)_CompilePython.make
cmt_final_setup_CompilePython = $(bin)Chic02ee_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Chic02eesetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(Chic02ee_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Chic02ee_tag).make
cmt_final_setup_CompilePython = $(bin)Chic02eesetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Chic02ee_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Chic02ee_qmtest_runsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(Chic02ee_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Chic02ee_tag)_qmtest_run.make
cmt_final_setup_qmtest_run = $(bin)Chic02ee_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Chic02eesetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(Chic02ee_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Chic02ee_tag).make
cmt_final_setup_qmtest_run = $(bin)Chic02eesetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Chic02ee_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Chic02ee_qmtest_summarizesetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(Chic02ee_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Chic02ee_tag)_qmtest_summarize.make
cmt_final_setup_qmtest_summarize = $(bin)Chic02ee_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Chic02eesetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(Chic02ee_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Chic02ee_tag).make
cmt_final_setup_qmtest_summarize = $(bin)Chic02eesetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Chic02ee_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Chic02ee_TestPackagesetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(Chic02ee_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Chic02ee_tag)_TestPackage.make
cmt_final_setup_TestPackage = $(bin)Chic02ee_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Chic02eesetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(Chic02ee_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Chic02ee_tag).make
cmt_final_setup_TestPackage = $(bin)Chic02eesetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Chic02ee_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Chic02ee_TestProjectsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(Chic02ee_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Chic02ee_tag)_TestProject.make
cmt_final_setup_TestProject = $(bin)Chic02ee_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Chic02eesetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(Chic02ee_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Chic02ee_tag).make
cmt_final_setup_TestProject = $(bin)Chic02eesetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
endif
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Chic02ee_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Chic02ee_new_rootsyssetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(Chic02ee_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Chic02ee_tag)_new_rootsys.make
cmt_final_setup_new_rootsys = $(bin)Chic02ee_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Chic02eesetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(Chic02ee_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Chic02ee_tag).make
cmt_final_setup_new_rootsys = $(bin)Chic02eesetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
endif
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Chic02ee_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Chic02ee_DatabaseSvc_check_install_scriptssetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Chic02ee_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Chic02ee_tag)_DatabaseSvc_check_install_scripts.make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Chic02ee_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Chic02ee_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Chic02eesetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Chic02ee_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Chic02ee_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Chic02eesetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
endif
