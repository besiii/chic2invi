...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(Chic2invi_tag).make
cmt_local_tagfile = $(bin)$(Chic2invi_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_Chic2invisetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_Chic2invisetup.make
else
#cmt_local_setup = $(bin)Chic2invisetup$(cmt_lock_pid).make
...
Chic2invi_extratags = -tag_add=target_Chic2invi

#$(cmt_local_tagfile_Chic2invi) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Chic2invi) ::
else
$(cmt_local_tagfile_Chic2invi) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_Chic2invi)"
	@if test -f $(cmt_local_tagfile_Chic2invi); then /bin/rm -f $(cmt_local_tagfile_Chic2invi); fi ; \
	  $(cmtexe) -tag=$(tags) $(Chic2invi_extratags) build tag_makefile >>$(cmt_local_tagfile_Chic2invi); \
	  if test -f $(cmt_final_setup_Chic2invi); then /bin/rm -f $(cmt_final_setup_Chic2invi); fi; \
	  $(cmtexe) -tag=$(tags) $(Chic2invi_extratags) show setup >>$(cmt_final_setup_Chic2invi)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_Chic2invi_makefile) :: $(Chic2invi_dependencies) $(cmt_local_tagfile_Chic2invi) build_library_links dirs
else
$(cmt_local_Chic2invi_makefile) :: $(cmt_local_tagfile_Chic2invi)
endif
	$(echo) "(constituents.make) Building Chic2invi.make"; \
	  $(cmtexe) -tag=$(tags) $(Chic2invi_extratags) build constituent_makefile -out=$(cmt_local_Chic2invi_makefile) Chic2invi

Chic2invi :: $(Chic2invi_dependencies) $(cmt_local_Chic2invi_makefile)
	$(echo) "(constituents.make) Starting Chic2invi"
	@$(MAKE) -f $(cmt_local_Chic2invi_makefile) cmt_lock_pid=$${cmt_lock_pid} Chic2invi
	$(echo) "(constituents.make) Chic2invi done"

clean :: Chic2inviclean

Chic2inviclean :: $(Chic2inviclean_dependencies) ##$(cmt_local_Chic2invi_makefile)
	$(echo) "(constituents.make) Starting Chic2inviclean"
	@-if test -f $(cmt_local_Chic2invi_makefile); then \
	  $(MAKE) -f $(cmt_local_Chic2invi_makefile) cmt_lock_pid=$${cmt_lock_pid} Chic2inviclean; \
	fi

##	  /bin/rm -f $(cmt_local_Chic2invi_makefile) $(bin)Chic2invi_dependencies.make

install :: Chic2inviinstall

Chic2inviinstall :: $(Chic2invi_dependencies) $(cmt_local_Chic2invi_makefile)
	$(echo) "(constituents.make) Starting install Chic2invi"
	@-$(MAKE) -f $(cmt_local_Chic2invi_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install Chic2invi done"

uninstall :: Chic2inviuninstall

Chic2inviuninstall :: $(cmt_local_Chic2invi_makefile)
	$(echo) "(constituents.make) Starting uninstall Chic2invi"
	@-$(MAKE) -f $(cmt_local_Chic2invi_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall Chic2invi done"
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(Chic2invi_tag)_config.make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_Chic2invi_configsetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
#cmt_local_tagfile_config = $(Chic2invi_tag)_config.make
cmt_local_tagfile_config = $(bin)$(Chic2invi_tag)_config.make
cmt_final_setup_config = $(bin)Chic2invi_configsetup.make
...
ifdef READONLY
cmt_local_tagfile_config = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_config = /tmp/CMT_Chic2invisetup.make
cmt_local_config_makefile = /tmp/CMT_config$(cmt_lock_pid).make
else
#cmt_local_tagfile_config = $(Chic2invi_tag).make
cmt_local_tagfile_config = $(bin)$(Chic2invi_tag).make
cmt_final_setup_config = $(bin)Chic2invisetup.make
cmt_local_config_makefile = $(bin)config.make
endif
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Chic2invi_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Chic2invi_install_includessetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(Chic2invi_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Chic2invi_tag)_install_includes.make
cmt_final_setup_install_includes = $(bin)Chic2invi_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Chic2invisetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(Chic2invi_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Chic2invi_tag).make
cmt_final_setup_install_includes = $(bin)Chic2invisetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Chic2invi_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Chic2invi_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(Chic2invi_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Chic2invi_tag)_make.make
cmt_final_setup_make = $(bin)Chic2invi_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Chic2invisetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(Chic2invi_tag).make
cmt_local_tagfile_make = $(bin)$(Chic2invi_tag).make
cmt_final_setup_make = $(bin)Chic2invisetup.make
cmt_local_make_makefile = $(bin)make.make
endif
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Chic2invi_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Chic2invi_CompilePythonsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(Chic2invi_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Chic2invi_tag)_CompilePython.make
cmt_final_setup_CompilePython = $(bin)Chic2invi_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Chic2invisetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(Chic2invi_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Chic2invi_tag).make
cmt_final_setup_CompilePython = $(bin)Chic2invisetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Chic2invi_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Chic2invi_qmtest_runsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(Chic2invi_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Chic2invi_tag)_qmtest_run.make
cmt_final_setup_qmtest_run = $(bin)Chic2invi_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Chic2invisetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(Chic2invi_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Chic2invi_tag).make
cmt_final_setup_qmtest_run = $(bin)Chic2invisetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Chic2invi_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Chic2invi_qmtest_summarizesetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(Chic2invi_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Chic2invi_tag)_qmtest_summarize.make
cmt_final_setup_qmtest_summarize = $(bin)Chic2invi_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Chic2invisetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(Chic2invi_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Chic2invi_tag).make
cmt_final_setup_qmtest_summarize = $(bin)Chic2invisetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Chic2invi_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Chic2invi_TestPackagesetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(Chic2invi_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Chic2invi_tag)_TestPackage.make
cmt_final_setup_TestPackage = $(bin)Chic2invi_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Chic2invisetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(Chic2invi_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Chic2invi_tag).make
cmt_final_setup_TestPackage = $(bin)Chic2invisetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Chic2invi_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Chic2invi_TestProjectsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(Chic2invi_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Chic2invi_tag)_TestProject.make
cmt_final_setup_TestProject = $(bin)Chic2invi_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Chic2invisetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(Chic2invi_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Chic2invi_tag).make
cmt_final_setup_TestProject = $(bin)Chic2invisetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
endif
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Chic2invi_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Chic2invi_new_rootsyssetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(Chic2invi_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Chic2invi_tag)_new_rootsys.make
cmt_final_setup_new_rootsys = $(bin)Chic2invi_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Chic2invisetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(Chic2invi_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Chic2invi_tag).make
cmt_final_setup_new_rootsys = $(bin)Chic2invisetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
endif
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Chic2invi_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Chic2invi_DatabaseSvc_check_install_scriptssetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Chic2invi_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Chic2invi_tag)_DatabaseSvc_check_install_scripts.make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Chic2invi_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Chic2invi_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Chic2invisetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Chic2invi_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Chic2invi_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Chic2invisetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
endif
