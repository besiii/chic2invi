...
## chicNoTDC
f0 = TFile('scripts/ee_decay/event/GDimuon_noTDC_veto.root')
f1 = TFile('scripts/ee_decay/event/GEBhabha_noTDC_veto.root')
f2 = TFile('scripts/ee_decay/event/GDiphoton_noTDC_veto.root')
f3 = TFile('run/chicNoTDC/hist_data3650/chicNoTDC_data3650_event_merged_veto.root')
...
h2_E.Scale(6.0)
h3_E.Scale(0.0008)
h0_E.GetYaxis().SetRangeUser(1, 150)
...
legend = TLegend(0.26, 0.70, 0.46, 0.87)
...
# mbc.SaveAs("python/plots/bhabha_egam1_no.pdf")

h0_E.GetXaxis().SetTitle("M_{#gamma#gamma} (GeV/c^{2})")
mbc.SaveAs("python/plots/bhabha_Mgamgam_no.pdf")
