...
f0 = TFile("scripts/chic0_invi/event_chic0/chic0_gam2invi_gen_mc_event_veto.root")
f1 = TFile("scripts/chic1_invi/event_chic1/chic1_gam2invi_gen_mc_event_veto.root")
f2 = TFile("scripts/chic2_invi/event_chic2/chic2_gam2invi_gen_mc_event_veto.root")
...
# h4_E.Scale(1)
h3_E.GetYaxis().SetRangeUser(0.1, 1000000)
...
legend = TLegend(0.45, 0.68, 0.77, 0.87)
