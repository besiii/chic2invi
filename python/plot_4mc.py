...
## chicNoTDC
# f0 = TFile("scripts/chic0_invi/event_chic0/chic0_gam2invi_gen_mc_noTDC_event_jpsi.root")
# f1 = TFile("scripts/chic1_invi/event_chic1/chic1_gam2invi_gen_mc_noTDC_event_jpsi.root")
# f2 = TFile("scripts/chic2_invi/event_chic2/chic2_gam2invi_gen_mc_noTDC_event_jpsi.root")
# f3 = TFile('run/chicNoTDC/hist_inclusiveMC/chicNoTDC_psip_mc_event_merged_jpsi.root')
...
# f4 = TFile('run/chicNoTDC/hist_data/chicNoTDC_psip_data_event_merged_jpsi.root')
# f5 = TFile('run/chicNoTDC/hist_data3650/chicNoTDC_data3650_event_merged_jpsi.root')
# f6 = TFile('scripts/ee_decay/event/GDimuon_noTDC_event_jpsi.root')
...
# h4_E.GetXaxis().SetTitle("E_{#gamma1} (GeV)")
# mbc.SaveAs("python/plots/egam1_n_jpsi.pdf")
