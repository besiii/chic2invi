...
f0 = TFile("scripts/chic0_invi/event_chic0/chic0_gam2invi_gen_mc_event_n.root")
f1 = TFile("scripts/chic1_invi/event_chic1/chic1_gam2invi_gen_mc_event_n.root")
f2 = TFile("scripts/chic2_invi/event_chic2/chic2_gam2invi_gen_mc_event_n.root")
f3 = TFile('run/chic2incl/hist_inclusiveMC/chic2incl_psip_mc_event_merged_n.root')
f4 = TFile('run/chic2incl/hist_data/chic2incl_psip_data_event_merged_n.root')
...
h4_E.GetYaxis().SetRange(0, 8000)

legend = TLegend(0.55, 0.6, 0.82, 0.8)
