...
def main():
    ...
    if logdir in ['event_data', 'event_inclusiveMC', 'rootfile_data', 'rootfile_data3650', 'rootfile_inclusiveMC', 'event', 'Data12_event', 'rootfile','Data12', 'data', 'mc_psip12', 'con3650', 'data09', 'mc_psip09']:
