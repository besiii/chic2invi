...
## chicNoTDC
chic0 = TChain('tree')
chic0.Add('scripts/chic0_invi/rootfile_chic0/chic0_gam2invi_gen_mc_noTDC.root')
chic1 = TChain('tree')
chic1.Add('scripts/chic1_invi/rootfile_chic1/chic1_gam2invi_gen_mc_noTDC.root')
chic2 = TChain('tree')
chic2.Add('scripts/chic2_invi/rootfile_chic2/chic2_gam2invi_gen_mc_noTDC.root')
incl = TChain('tree')
incl.Add('run/chicNoTDC/hist_inclusiveMC/chicNoTDC_psip_mc_merged_1.root')

fromchic0 = TH1D('fromchic0', '', 100, 0.0, 0.6)
fromchic0.SetLineColor(ROOT.kRed)
fromchic1 = TH1D('fromchic1', '', 100, 0.0, 0.6)
fromchic1.SetLineColor(ROOT.kBlue)
fromchic2 = TH1D('fromchic2', '', 100, 0.0, 0.6)
fromchic2.SetLineColor(ROOT.kMagenta)
fromincl = TH1D('fromincl', '', 100, 0.0, 0.6)
...
legend = TLegend(0.6, 0.68, 0.82, 0.88)
...
# legend.Draw()
mbc.SaveAs("python/plots/same4mc_noTDC.pdf")
