#ifndef Chi2gll_Header
#define Chi2gll_Header
...
//namespace
//
class Chi2gll:public Algorithm {
  public:
    Chi2gll(const std::string& name, ISvcLocator* pSvcLocator);
    ~Chi2gll();
...
void mctruth();
void saveLepton(EvtRecTrackIterator itTrk, int &a , int type);
  ...
  private:
	...
	NTuple::Item<int> m_nlepton, m_ntrk, m_nshw, m_ncharged, m_nneutral;
